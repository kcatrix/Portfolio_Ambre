...
// Nombre de symboles flottants (monte le chiffre pour plus de densité)
const count = 60
</script>

<template>
  <div id="background">
    <div v-for="n in count" :key="n"><span></span></div>
  </div>
</template>
...
#background span:after {
  ...
  background-image: url(https://images.unsplash.com/photo-1580822115965-0b2532068eff?&q=100&w=200&dpr=2);
